...
function WebOffice2015 () {
  ...
  this.ModifyReview = function () {
      ...
      if (this.obj.ActiveDocument.Application.CommandBars.Item('Track Changes').Controls.Item(i).ID == 1715) { this.obj.ActiveDocument.Application.CommandBars.Item('Track Changes').Controls.Item(i).Enabled = false }
      if (this.obj.ActiveDocument.Application.CommandBars.Item('Track Changes').Controls.Item(i).ID == 1716) { this.obj.ActiveDocument.Application.CommandBars.Item('Track Changes').Controls.Item(i).Enabled = false }
      if (this.obj.ActiveDocument.Application.CommandBars.Item('Track Changes').Controls.Item(i).ID == 2041) { this.obj.ActiveDocument.Application.CommandBars.Item('Track Changes').Controls.Item(i).Enabled = false }
    }
    	this.obj.RibbonCustomUI = strCustomUI
  }
